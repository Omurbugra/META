...
const Gallery: React.FC = () => {
                ...
                <div className={`grid lg:grid-cols-12 gap-16 items-center min-h-screen py-20 ${
                  ...
                  <div className={`lg:col-span-8 ${index % 2 === 0 ? '' : 'lg:col-start-5'}`}>
                    ...
                    >
                      ...
                      <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                        <div className="w-12 h-12 bg-card/90 bg-card/90 rounded-full flex items-center justify-center">
                          <Maximize2 className="h-5 w-5 text-gray-900 dark:text-gray-100" />
                        </div>
                      </div>

                      {/* Subtle overlay on hover */}
                      <div className="absolute inset-0 bg-background/0 group-hover:bg-background/5 transition-all duration-700"></div>
                  ...
                  <div className={`lg:col-span-4 space-y-8 ${index % 2 === 0 ? '' : 'lg:col-start-1'}`}>
                    <div className="space-y-6">
                      {/* Section Number */}
                      <div className="text-sm font-light text-gray-400 dark:text-muted-foreground tracking-widest uppercase">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {project.tags.slice(0, 3).map((tag) => (
                            <span
                                key={tag}
                                className="text-xs text-gray-500 dark:text-gray-500 font-light tracking-wide border border-gray-200 dark:border-border px-3 py-1"
                            >
                        {tag}
                      </span>
                        ))}
        ...
        {filteredProjects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden bg-background mb-8">
                ...
                {/* Zoom Indicator */}
                <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="w-10 h-10 bg-card/90 bg-card/90 rounded-full flex items-center justify-center">
  ...
  return (
      ...
      {/* Fixed Navigation Bar */}
        <div className="fixed top-16 left-0 right-0 z-40 bg-background text-foreground border-b border-border backdrop-blur-sm">
              ...
              <div className="flex items-center space-x-8">
                ...
                <div className="relative">
                  ...
                  <input
                      ...
                      className="pl-12 pr-4 py-3 w-64 bg-transparent border border-gray-200 dark:border-border text-gray-900 dark:text-gray-100 font-light tracking-wide focus:border-gray-900 dark:focus:border-gray-100 transition-colors duration-300"
                  />
                  {searchQuery && (
                      <button
                          onClick={() => setSearchQuery('')}
                          className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-muted-foreground dark:hover:text-gray-300"
                      >
                        <X className="h-4 w-4" />
                      </button>
                  )}
                  ...
                  <button
                      ...
                      className={`p-3 transition-colors duration-300 ${
                          viewMode === 'exhibition'
                              ...
                              : 'text-gray-400 hover:text-muted-foreground dark:hover:text-gray-300'
                      }`}
                ...
                <button
                    ...
                    className="flex items-center space-x-2 text-muted-foreground dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 font-light tracking-wide transition-colors duration-300"
                >
          ...
          {filteredProjects.length === 0 ? (
              <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 dark:text-muted-foreground font-light">
