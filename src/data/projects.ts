...
export const projects: Project[] = [
  {
    ...
    thumbnailUrl: '/META/IMAJ/thumb/eco.jpg',
  ...
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/CorrespondenceMap.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/CorrespondenceMap.jpg',
  ...
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/CHRONOGRAM.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/CHRONOGRAM.jpg',
    aspectRatio: 'landscape',
  ...
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/circle.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/circle.jpg',
    aspectRatio: 'square',
  ...
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/orbit.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/orbit.jpg',
    aspectRatio: 'square',
    tags: ['themes'],
    year: 2025,
    featured: true
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/Citation_Geographies.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/Citation_Geographies.jpg',
    aspectRatio: 'portrait',
  ...
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/Citation_Chronologies.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/Citation_Chronologies.jpg',
    aspectRatio: 'portrait',
    tags: ['citation', 'time'],
    year: 2025,
    featured: true
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/Dymaxion.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/Dymaxion.jpg',
    aspectRatio: 'landscape',
    tags: ['dymaxion', 'map'],
    year: 2025,
    featured: true
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/drawings6.1.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/drawings6.1.jpg',
    aspectRatio: 'portrait',
    tags: ['drawing'],
    year: 2025,
    featured: true
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/drawings6.2.jpg'],
    thumbnailUrl: '/META/IMAJ/thumb/drawings6.2.jpg',
    aspectRatio: 'portrait',
    tags: ['drawing'],
    year: 2025,
    featured: true
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/sozluk_1.jpg', '/META/IMAJ/sozluk_2.jpg', '/META/IMAJ/sozluk_3.jpg', '/META/IMAJ/sozluk_4.jpg', '/META/IMAJ/sozluk_5.jpg', '/META/IMAJ/sozluk_on.jpg'],
    thumbnailUrl: '/META/IMAJ/sozluk_on.jpg',
    aspectRatio: 'portrait',
    tags: ['dictionary'],
    year: 2025,
    featured: true
  },
  {
    ...
    thumbnailUrl: '/META/IMAJ/thumb/motion.jpg',
    aspectRatio: 'landscape',
    tags: ['animation'],
    year: 2025,
    featured: true
  },
  {
    ...
    thumbnailUrl: '/META/IMAJ/thumb/Corpus.jpg',
    aspectRatio: 'square',
    tags: ['slideshow'],
    year: 2025,
    featured: true
  },
  {
    ...
    thumbnailUrl: '/META/IMAJ/thumb/source.jpg',
    aspectRatio: 'landscape',
    tags: ['3d', 'citation'],
    year: 2025,
    featured: true
  },
  {
    ...
    mediaType: 'image',
    mediaUrls: ['/META/IMAJ/desk_1.jpg', '/META/IMAJ/desk_2.jpg', '/META/IMAJ/desk_3.jpg', '/META/IMAJ/desk_4.jpg', '/META/IMAJ/desk_5.jpg'],
    thumbnailUrl: '/META/IMAJ/desk_1.jpg',
    aspectRatio: 'portrait',
    tags: ['editorial'],
    year: 2025,
    featured: true
